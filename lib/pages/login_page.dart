...
class _LoginPageState extends State<LoginPage> {
  ...
  SizedBox registerButton(double width, double height) {
    return SizedBox(
      ...
      child:  ElevatedButton(
        style: ButtonStyle(
          backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 64, 255, 38)),
        ...
        onPressed: () {},
        child: const Text('สมัครสมาชิก',style: TextStyle(color: Colors.black,fontSize: 17,fontWeight: FontWeight.bold),),
      ),
    );
  }
      ...
      child: ElevatedButton(
          ...
          onPressed: () async {
            if (_formKey.currentState!.validate()) {
              ...
              var url = Uri.parse(
                  'https://laravelapi117.herokuapp.com/api/login');
          ...
          child: const Text('เข้าสู่ระบบ',style: TextStyle(color: Color.fromARGB(255, 255, 255, 255),fontSize: 17,fontWeight: FontWeight.bold))),
    );
  }
  ...
  Container inputEmail() {
    return Container(
      width: 250,
      margin: const EdgeInsets.only(left: 32, right: 32, top: 80, bottom: 20),
      child: TextFormField(
        controller: _email,
